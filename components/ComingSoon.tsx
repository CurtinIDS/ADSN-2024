...
const ComingSoon = () => {
  return (
    <div className="p-3 md:p-10 relative flex justify-center items-center w-full bg-cover bg-center bg-[url('/ADSN-2024/background_coming_soon.webp')]">
      <div className="text-center text-white">
        <h1 className="p-3 md:p-6 font-extrabold md:tracking-wide md:text-4xl">
        ...
        <div className="p-3 md:p-6 flex flex-row">
