  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-7xl">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="text-sm flex flex-wrap justify-center md:justify-start space-x-6 md:space-x-8">
                ...
                >
                  <Image
                    src="/ADSN-2024/sponsor_logos/ardc_logo.png"
        ...
        <div className="col-span-1 lg:col-span-4 grid lg:grid-cols-2 lg:gap-8 mt-8">
          <div className="text-center lg:text-left">
            <p className="text-sm text-gray-400">&copy; 2024 Australian Data Science Network. All rights reserved.</p>
          </div>

          <div className="text-center lg:text-left">
            <ul className="list-none flex justify-center lg:justify-start flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6">
